...
//The physical pinhole camera we want to model
float focalLength = 55; //in mm
...
int main(int argc, char** argv)
{
    ...
    switch (fitFilm)
    {
    //Fit resolution gate within film gate
    case kFill:
    ...
    Matrix4f cameraToWorld(-0.95424, 0, 0.299041, 0, 0.0861242, 0.95763, 0.274823, 0, -0.28637, 0.288002, -0.913809, 0, -3.734612, 7.610426, -14.152769, 1);
