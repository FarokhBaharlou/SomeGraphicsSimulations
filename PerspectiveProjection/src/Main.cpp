...
//List of vertices making up the objec
...
void computePixelCoordinates(const Vec3f pWorld, Vec2i& pRaster, const Matrix4f& worldToCamera, const float& canvasWidth, const float& canvasHeight, const uint32_t& imageWidth, const uint32_t& imageHeight)
{
    Vec3f pCamera;
...
int main(int argc, char** argv)
{
    ...
    Matrix4f cameraToWorld(0.871214, 0, -0.490904, 0, -0.192902, 0.919559, -0.342346, 0, 0.451415, 0.392953, 0.801132, 0, 14.777467, 29.361945, 27.993464, 1);
